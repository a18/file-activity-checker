...
The checker was originally created as a reminder for Pomodoro's time management methodology. However, it can be used for other similar scenarios when it is necessary to track the activity of a given file.
